...
const AboutMe = () => {
  ...
  return (
    <div className="max-w-[65rem] mx-auto flex justify-between gap-8 ">
      <motion.div className="flex-1 max-w-[45rem] hover:cursor-pointer" {...dragValues}>
        <div className="px-8 py-7 lg:rounded-xl backdrop-blur-md bg-black/3 ring-1 ring-black/10">
          ...
          <p className="text-xl pb-1">
            Having focused on UI/UX design in my bachelor's thesis, and being interested in the field, I decided to
            deepen my expertise by completing the WBS Coding School Full-Stack Developer bootcamp in July 2025. I am now
            eager to apply and expand my digital design skills.
          </p>
        </div>
      </motion.div>
      <motion.div
        className="w-[20rem] flex-shrink-0 px-8 py-7 lg:rounded-xl backdrop-blur-md bg-black/3 ring-1 ring-black/10 hover:cursor-pointer"
        {...dragValues}>
